...
from Segmentation.utils.losses import dice_coef, dice_coef_loss, dice_loss
    ...
    for chkpt in session_weights:
        ...
        for idx, ds in enumerate(dataset):
            ...
            if (get_depth(sample_pred) + batch_size) < target:  # check if next batch will fit in volume (160)
                ...
                print("DICE JOE:", dice_loss(y_vol, pred_vol))
                ...
                if idx == 2:
                    ...
                    print("DICE JOE BATCH:", dice_loss(batch_y_vols, batch_pred_vols))
                    print("DICE BATCH:", dice_coef(batch_y_vols, pred_batch_pred_volsvol))
