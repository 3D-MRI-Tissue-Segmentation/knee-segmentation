...
def plot_confusion_matrix(y_true, y_pred, savefig, classes, normalise=True, title='confusion matrix', cmap=plt.cm.Blues):
    ...
    # zeros = np.zeros((y_true.shape[1], y_true.shape[1]))
