...
def train(model, n_classes=1, batch_size=1, sample_shape=(128, 128, 128), epochs=10,
    ...
    if validate:
        ax3.plot(history_1.history['val_dice_loss'], label="val dice loss")
        ax3.plot(running_mean(history_1.history['val_dice_loss'], roll_period), label="val dice loss")
...
if __name__ == "__main__":
    ...
    t2 = train("small", batch_size=batch_size, sample_shape=(240, 240, 160), epochs=e,
               examples_per_load=examples_per_load,
