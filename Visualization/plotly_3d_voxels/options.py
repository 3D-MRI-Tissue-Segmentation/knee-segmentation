...
class Options():
    ...
    def parse(self):
        ...
        if self.opt.dataroot_left:
            ...
            assert os.path.isdir(self.opt.dataroot_left), '%s is not a valid directory' % self.opt.dataroot_left
        ...
        if self.opt.dataroot_right:
            ...
            assert os.path.isdir(self.opt.dataroot_right), '%s is not a valid directory' % self.opt.dataroot_right
