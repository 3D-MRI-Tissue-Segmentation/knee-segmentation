# Panda 3d https://docs.panda3d.org/1.10/python/programming/models-and-actors/loading-actors-and-animations
# Install Panda 3d:  
#   https://github.com/panda3d/panda3d
#   https://docs.panda3d.org/1.10/python/introduction/installation-linux
#   https://libraries.io/pypi/Panda3D
# Install 3rd Party Panda 3d:
#   https://www.panda3d.org/download/panda3d-1.10.5/panda3d-1.10.5-tools-mac.tar.gz
#   
# Since Panda3d is a library, you have to be in the environment you installed Panda3d onto to use any Panda3d files.
# Panda3d comes installed with its own version of python, so it is not guaranteed to use the same version you use as a defualt.
# 
# 
# Basically just tryna render a basic toy dataset, playing around with the visualisation
