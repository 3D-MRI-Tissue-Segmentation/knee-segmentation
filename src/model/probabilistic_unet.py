...
from utils.training_utils import cross_entropy_loss
...
class UNet(tf.keras.Model):
    ...
    def __init__(self, 
        ...
        self.Conv_1 = tf.keras.layers.Conv2D(64, num_convs_per_block, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_2 = tf.keras.layers.Conv2D(128, num_convs_per_block, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_3 = tf.keras.layers.Conv2D(256, num_convs_per_block, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_4 = tf.keras.layers.Conv2D(512, num_convs_per_block, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_5 = tf.keras.layers.Conv2D(1024, num_convs_per_block, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_6 = tf.keras.layers.Conv2D(512, 2, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_7 = tf.keras.layers.Conv2D(256, 2, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_8 = tf.keras.layers.Conv2D(128, 2, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_9 = tf.keras.layers.Conv2D(64, 2, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_10 = tf.keras.layers.Conv2D(2, num_convs_per_block, activation = nonlinearity, padding='same', data_format=data_format)
        self.Conv_11 = tf.keras.layers.Conv2D(num_channels, 1, activation = nonlinearity, padding='same', data_format=data_format)
